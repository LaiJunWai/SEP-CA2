                ...
                <ul class="nav nav-pills nav-main" id="mainMenu">\
                    <li class="dropdown">\
                        ...
                        <ul class="dropdown-menu">\
                            <li><a href="/B/' + countryPrefix + '/showroom.html?room=Living Room">Living Room</a></li>\
                            <li><a href="/B/' + countryPrefix + '/showroom.html?room=Bedroom">Bedroom</a></li>\
                            <li><a href="/B/' + countryPrefix + '/showroom.html?room=Study Room">Study Room</a></li>\
                            <li><a href="/B/' + countryPrefix + '/showroom.html?room=Kids Room">Kids Room</a></li>\
                            <li><a href="/B/' + countryPrefix + '/showroom.html?room=Bathroom">Bathroom</a></li>\
                            <li><a href="/B/' + countryPrefix + '/showroom.html?room=Kitchen">Kitchen</a></li>\
                            <li><a href="/B/' + countryPrefix + '/showroom.html?room=Utility Room">Utility Room</a></li>\
                        </ul>\
                    </li>\
                    <li>\
